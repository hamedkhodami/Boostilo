    ...
    var myChart = new Chart(ctx, {
        ...
        options: {
            ...
            onClick: (evt, item) => {
                if (item.length) {
                    ...
                    const sections = ['research', 'smart-ideation', 'content-creation', 'publishing', 'branding'];
            ...
            plugins: {
                ...
                datalabels: {
                    color: '#fff',
                    font: {
                        size: window.innerWidth > 768 ? 18 : 10,
                        weight: '700'
                    },
                    align: 'center',
                    anchor: 'center',
        ...
        plugins: [{ beforeDraw: drawCenterText }, ChartDataLabels]
    });
