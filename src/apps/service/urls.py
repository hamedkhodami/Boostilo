...
urlpatterns = [
    ...
    path('category/<int:category_id>/',views.CategoryProductsView.as_view(), name='category_products'),    path('application/', views.ServiceApplicationPageView.as_view(), name='application'),
